  ...
  return (
    <>
      <div
        ...
        className={`w-full max-[500px]:min-h-[650px] min-h-[450px] max-[640px]:min-h-[600px] bg-cover bg-no-repeat bg-center relative z-10 flex justify-center items-center`}
      >
        {/* Overlay Blue */}
        <div className="bg-[#2563EBDB] max-[500px]:min-h-[650px] max-[640px]:min-h-[600px] inset-0 absolute opacity-[96%] min-h-[450px]"></div>

        {/* Main Content */}
        <div className="w-[730px] h-[276px] inset-0 relative z-20 mt-12">
          {/* Text Section */}
